...
import com.example.hp.dip.util.Util;
import static com.example.hp.dip.util.Util.selectedRegion;
...
public class SightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            sights = new ExecuteSight(this,sightRecycler,false).execute(url).get();
            sightRecycler.addOnItemTouchListener(
                    new RecyclerClickListener(this, new RecyclerClickListener.OnItemClickListener() {
                        ...
                        public void onItemClick(View view, int position) {
                            ...
                            intent.putExtra(ViewActivity.ALL, "3");
